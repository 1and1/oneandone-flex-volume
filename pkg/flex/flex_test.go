...
func TestNexFlexCommand(t *testing.T) {
	cases := []struct {
		...
		{
			[]string{"cmd", "getvolumename", `{"kubernetes.io/fsType":"ext4","kubernetes.io/pvOrVolumeName":"prueba","kubernetes.io/readwrite":"rw","storageID":"id0123456789","storageName":"prueba","kubernetes.io/secret/apiKey" : "secret"}`},
			&Command{
				command: "getvolumename",
				options: `{"kubernetes.io/fsType":"ext4","kubernetes.io/pvOrVolumeName":"prueba","kubernetes.io/readwrite":"rw","storageID":"id0123456789","storageName":"prueba","kubernetes.io/secret/apiKey" : "secret"}`,
			},
			false,
		},
	}
